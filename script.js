...
app.addEventListener("click",(eo) => {
  shuffle.getElementsByClassName("active-shuffle")[0].classList.remove("active-shuffle")
...
const bullets_test = document.querySelectorAll(".testimonials .bullets .bullet")
...
bullets_test.forEach((item,index) => {
  item.addEventListener("click",(eo) => {
    list_bull.getElementsByClassName("active-bullet")[0].classList.remove("active-bullet")
